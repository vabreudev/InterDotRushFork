...
# This is a fork of original DotRush to guarantee security and version control

### C# Development Environment for Visual Studio Code

&emsp;InterDotRush is a powerful, lightweight, and efficient **C# Development Environment** designed for **VS Code**. Built with performance and simplicity in mind, InterDotRush provides a seamless development experience for C# developers.
...
- **Performance** </br>
  Lightweight and efficient, InterDotRush is designed to be fast and responsive.

## Working with Projects and Solutions

&emsp;If your folder contains multiple projects or a solution file, InterDotRush will show the following picker for all projects and solutions in the folder. InterDotRush automatically saves selected projects and solutions in the workspace settings. You can open it manually by executing the `InterDotRush: Pick Project or Solution files` command:

![image](https://github.com/JaneySprings/InterDotRush/raw/main/assets/image1.jpg)
...
![image](https://github.com/JaneySprings/InterDotRush/raw/main/assets/image2.jpg)
...
![image](https://github.com/JaneySprings/InterDotRush/raw/main/assets/image3.jpg)
...
![image](https://github.com/JaneySprings/InterDotRush/raw/main/assets/image4.jpg)
...
&emsp;InterDotRush currently supports **only C# language** features and does not support `Razor`, `XAML`, or other languages. Also it does not support the following language features:

- **CodeLens** </br>
  InterDotRush does not support [CodeLens features](https://code.visualstudio.com/api/language-extensions/programmatic-language-features#codelens-show-actionable-context-information-within-source-code) such as references, tests, and other CodeLens features.
