...
using InterDotRush.Roslyn.Navigation.Decompilation;
using Microsoft.CodeAnalysis;
using Microsoft.CodeAnalysis.Text;
using FileSystemExtensions = InterDotRush.Common.Extensions.FileSystemExtensions;

namespace InterDotRush.Roslyn.Navigation;
