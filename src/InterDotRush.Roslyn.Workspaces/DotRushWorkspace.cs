...
using InterDotRushMSBuildLocator = InterDotRush.Common.MSBuild.MSBuildLocator;

namespace InterDotRush.Roslyn.Workspaces;

public abstract class InterDotRushWorkspace : SolutionController
{
    ...
    private bool TryRegisterDotNetEnvironment()
    {
        ...
        {
            var latestSdkPath = InterDotRushMSBuildLocator.GetLatestSdkLocation();
