...
using InterDotRush.Common.InteropV2;
using InterDotRush.Roslyn.Workspaces.FileSystem;
using Microsoft.CodeAnalysis;
using NUnit.Framework;

namespace InterDotRush.Roslyn.Workspaces.Tests;

public class TestWorkspace : InterDotRushWorkspace, IWorkspaceChangeListener
{
