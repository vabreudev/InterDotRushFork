...
namespace InterDotRush.Roslyn.Server.Handlers.Framework;
...
public class SolutionDiagnosticsHandler : IJsonHandler
{
    ...
    {
        lspCommunication.AddNotificationHandler("InterDotRush/solutionDiagnostics", delegate (NotificationMessage message, CancellationToken token)
        {
